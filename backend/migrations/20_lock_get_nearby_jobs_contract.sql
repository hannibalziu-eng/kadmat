-- =============================================
-- LOCK CANONICAL CONTRACT: get_nearby_jobs
-- Re-applies canonical definition and stores expected hash from
-- pg_get_functiondef so contract checks remain stable.
-- =============================================
