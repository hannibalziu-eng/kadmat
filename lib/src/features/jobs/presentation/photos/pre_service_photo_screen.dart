// lib/src/features/jobs/presentation/photos/pre_service_photo_screen.dart
...
/// Pre-Service Photo Screen
/// Allows technician to capture 1-5 photos before starting work
/// and add a description of the problem
class PreServicePhotoScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PreServicePhotoScreen> createState() =>
      _PreServicePhotoScreenState();
}
...
class _PreServicePhotoScreenState extends ConsumerState<PreServicePhotoScreen> {
  ...
  Future<void> _uploadPhotos() async {
    ...
    try {
      ...
      await repository.uploadPreServicePhotos(
        widget.jobId,
        xFiles,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('صور قبل الخدمة'), centerTitle: true),
      body: SafeArea(
        child: Column(
          children: [
            // Instructions
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'التقط من 1 إلى 5 صور توضح المشكلة قبل البدء بالعمل',
                      style: TextStyle(
                        fontSize: 14.fz,
